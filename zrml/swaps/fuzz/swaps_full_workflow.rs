...
fuzz_target!(|data: Data| {
    ...
    let _ = ext.execute_with(|| {
        ...
        let _ = Swaps::swap_exact_amount_out(
            ...
            data.swap_exact_amount_out_max_asset_amount_in,
...
struct Data {
    ...
    swap_exact_amount_in_min_asset_amount_out: Option<u128>,
    ...
    swap_exact_amount_out_max_asset_amount_in: Option<u128>,
